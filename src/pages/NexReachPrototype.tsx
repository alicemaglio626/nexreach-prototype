                      ...
                      <Flex justify="space-between" align="flex-start" gap={8} mb={(retrievalMethod === 'onsite' || isInbound) ? 8 : 0}>
                        ...
                        <Group gap={8} wrap="wrap" justify="flex-end" style={{ flex: 1 }}>
                          ...
                          {retrievalMethod === 'onsite' ? (
                            ...
                            <FilterPill label="Scheduling Status" options={['New', 'Scheduled', 'In Research', 'Rerouted', 'Pended', 'Progress Logged']} selected={filters['Scheduling Status']} onToggle={(v) => toggleFilter('Scheduling Status', v)} />
                          )}
